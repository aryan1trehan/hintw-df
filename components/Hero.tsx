...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    function liquidY(r: typeof ribbons[0], nx: number, t: number) {
      return r.baseY
    ...
    function liquidW(r: typeof ribbons[0], nx: number, t: number) {
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-stretch sm:items-center w-full max-w-md sm:max-w-none mx-auto">
          ...
          <Link
            ...
            style={{ backgroundColor: '#000000', color: '#ffffff', borderColor: '#ffffff', WebkitTextFillColor: '#ffffff' }}
          >
            Our Services
          </Link>
        </div>
