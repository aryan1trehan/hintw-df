...
const services = [
  { title: 'Meta Advertising', description: 'High-performance campaigns that drive measurable results', link: '/meta' },
  { title: 'SEO', description: 'Scalable organic growth for brands that demand authority', link: '/seo' },
  { title: 'Web Development', description: 'High-performance websites engineered for conversion', link: '/web-dev' },
  { title: 'UI/UX Design', description: 'User-centered design that creates intuitive experiences', link: '/ui-ux' },
  { title: 'Branding', description: 'Complete brand identity systems that command attention', link: '/branding' },
  { title: 'SaaS Development', description: 'Scalable SaaS solutions that grow with your business', link: '/saas' },
]
...
const icons = [
  ...
  <svg key="2" className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>,
  <svg key="3" className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" /></svg>,
  <svg key="4" className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" /></svg>,
  <svg key="5" className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg>,
  <svg key="6" className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>,
]
...
export default function ServicesSection() {
  return (
    <section>
      <style>{`
        .service-card:hover .service-title { color: #1a0905 !important; }
        .service-card:hover .service-desc { color: #1a0905 !important; }
        .service-card:hover .service-link { color: #1a0905 !important; }
        .service-card:hover svg { color: #1a0905 !important; }
      `}</style>
