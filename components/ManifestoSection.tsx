      ...
      <div className="hidden md:block" style={{ padding:'3rem 0', background:'#1b0904', borderBottom:'1px solid rgba(255,255,255,0.1)' }}>
        ...
        <div className="manifesto-inner">
          <div className="manifesto-label">
            <div style={{ fontFamily:'var(--font-montserrat)', fontSize:'.7rem', fontWeight:700, color:'rgba(157,176,195,0.5)', letterSpacing:'.15em', textTransform:'uppercase', lineHeight:1.6 }}>
              Founders<br />Message
            </div>
          </div>
          <div style={{ flex:1 }}>
            <span style={{ fontFamily:'var(--font-cormorant)', fontSize:'clamp(3rem,6vw,6rem)', lineHeight:0.4, color:'rgba(157,176,195,0.2)', display:'block', marginBottom:8 }}>&ldquo;</span>
            <h2 style={{ fontFamily:'var(--font-cormorant)', fontSize:'clamp(1.5rem,3vw,2.5rem)', fontWeight:700, color:'#9db0c3', lineHeight:1.3 }}>
              From presence to permanence, Enhanccee builds brands that define their era.
            </h2>
            <span style={{ fontFamily:'var(--font-cormorant)', fontSize:'clamp(3rem,6vw,6rem)', lineHeight:0.2, color:'rgba(157,176,195,0.2)', display:'block', textAlign:'right', marginBottom:24 }}>&rdquo;</span>
            <div style={{ height:1, width:64, background:'#C9A84C', marginLeft:'auto', marginBottom:20 }} />
            <p style={{ color:'rgba(157,176,195,0.5)', fontSize:'clamp(.85rem,1.2vw,1rem)', fontWeight:300, letterSpacing:'0.05em', textAlign:'right' }}>
              This is our commitment to every partner who walks through our doors.
            </p>
          </div>
        </div>
